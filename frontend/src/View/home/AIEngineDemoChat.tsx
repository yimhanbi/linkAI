...
const USER_MSG =
  "dlduswns이 발명한 특허가 있나요? 그리고 안 제민과 강경 태가 각각 발명한 특허도 알려주세요.";
const THINKING_MSG =
  "질문을 분석 중입니다... 'dlduswns'을 '이연준'으로 정정합니다.";
const ANSWER_MSG = `다음으로 정리해 드립니다. ('dlduswns'는 한영전환 오류로 보이며 '이연준'으로 정정)
...
10-2021-0101096: 프리로드 스캐닝을 이용한 웹 페이지 로딩 방법

10-2020-0057329: 프록시 서버 및 이를 이용한 웹 오브젝트 예측 방법

강경태 발명 특허

10-2024-0000776: 압력감지센서 및 모니터링 서비스 제공 방법

10-2023-0164745: 음성길이를 고려한 기계번역 장치 및 방법`;
